...
def load_configuration(
    ...
    # La fecha de simulacion se recibe por parametro para poder ejecutar
    # varios dias con el mismo escenario sin modificar el JSON base.
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        required=True,
        help=(
            "Fecha del dia a simular en formato YYYY-MM-DD. "
            "Este valor reemplaza la fecha definida en simulation_config.json."
        ),
    )
    ...
    summary["simulation_date_source"] = "cli_parameter"
    summary["simulation_date"] = args.simulation_date
